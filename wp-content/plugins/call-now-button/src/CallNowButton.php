...
class CallNowButton {
    ...
    public function register_styles_and_scripts() {
	    ...
	    wp_register_script(
		    ...
		    plugins_url( '../resources/js/billing-portal.js', __FILE__ ),
		    array( 'jquery' ),
		    CNB_VERSION,
		    true );
        wp_register_script(
	    ...
	    wp_register_script(
		    ...
		    plugins_url( '../resources/js/button-overview.js', __FILE__ ),
		    array( CNB_SLUG . '-call-now-button' ),
		    CNB_VERSION,
        ...
        wp_register_script(
            ...
            plugins_url( '../resources/js/action-edit-facebook.js', __FILE__ ),
            array( CNB_SLUG . '-call-now-button' ),
            CNB_VERSION,
            true );
	    wp_register_script(
		    CNB_SLUG . '-action-edit-viber',
		    plugins_url( '../resources/js/action-edit-viber.js', __FILE__ ),
		    array( CNB_SLUG . '-call-now-button' ),
		    CNB_VERSION,
		    true );
        wp_register_script(
	    ...
	    wp_register_script(
		    CNB_SLUG . '-templates',
		    plugins_url( '../resources/js/templates.js', __FILE__ ),
