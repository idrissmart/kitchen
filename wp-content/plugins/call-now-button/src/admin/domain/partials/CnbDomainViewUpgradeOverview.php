...
class CnbDomainViewUpgradeOverview {
    ...
    public function render_pro_features_nice_view() {
        ...
        <div class="cnb-block">
            ...
            <h2>Button Flower</h2>
            <img class="cnb-width-80"
                 src="<?php echo esc_url( WP_PLUGIN_URL . '/' . CNB_BASEFOLDER . '/resources/images/button-flower.png' ); ?>"
                 alt="Buttonbar">
            ...
            <h2>Button Dots</h2>
            <img class="cnb-width-80"
                 src="<?php echo esc_url( WP_PLUGIN_URL . '/' . CNB_BASEFOLDER . '/resources/images/dots.png' ); ?>"
                 alt="Buttonbar">
