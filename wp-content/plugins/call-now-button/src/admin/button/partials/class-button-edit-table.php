...
class Button_Edit_Table {
    ...
    function render_tab_basic_options( $button, $hide_on_modal, $default_domain ) {
        ...
        $cnb_multi_image_url        = plugins_url( '../../../../resources/images/button-new-multibutton.gif', __FILE__ );
	    $cnb_multi_flower_image_url = plugins_url( '../../../../resources/images/button-new-flower.gif', __FILE__ );
	    $cnb_full_image_url         = plugins_url( '../../../../resources/images/button-new-buttonbar.png', __FILE__ );
	    $cnb_full_single_image_url  = plugins_url( '../../../../resources/images/button-new-full.png', __FILE__ );
	    $cnb_dots_image_url         = plugins_url( '../../../../resources/images/button-new-dots.png', __FILE__ );
